...
for ham in hams:
    if(count < TRAINING):
        ...
        hams_sentences.append(tmp_list)
        tmp_list = []
        count += 1
count = 0
...
for spam in spams:
    if(count < TRAINING):
        ...
        spams_sentences.append(tmp_list)
        tmp_list = []
        count += 1
count = 0

print spams_sentences
...
spamlabeledSentences = models.doc2vec.LabeledListSentence(spams_sentences)
spammodel = models.doc2vec.Doc2Vec(spamlabeledSentences, min_count=0)

print spammodel.labels

print spammodel.most_similar_labels('SENT_0')
print spammodel.most_similar_words('money')
print spammodel.most_similar_words('spam')
